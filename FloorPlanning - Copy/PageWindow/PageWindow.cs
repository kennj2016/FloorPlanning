...
// PlanDraw
using PlanDraw.PageWindow.enums;

namespace PlanDraw.PageWindow
{
  /* TODOs
   * 
  ...
  */
  ...
  public class PageWindow : UserControl
  {
    ...
    /// <summary>
    /// Gets or sets the page orientation, Landscape or Portrait
    /// </summary>
    [Description("Determines or sets the orientation of the page."), Category("Preview Properties")]
        ...
        set
        {
            ...
            {   
                ...
                if (value == PageOrientation.Portrait)
                    // But has been set to Portrait, so we exchange width and height
            ...
            else
            {
                ...
                if (value == PageOrientation.Landscape)
                    // But has been set to Landscape, so we exchange width and height
                    this.pageSize = new SizeF((float)this.pageSize.Height, (float)this.pageSize.Width);
            }
    ...
    internal void CalculatePreviewDimension(out bool zoomChanged)
    {
      ...
      // Size of page in preview window in pixels
      ...
      // Borders do not depend on zoom anymore
